...
helm upgrade --install rancher rancher-latest/rancher --namespace cattle-system --set replicas=1 --set hostname=localhost --wait --timeout=10m --create-namespace --set rancherImage=rancher/rancher --set rancherImageTag="$RANCHER_IMAGE_TAG"
