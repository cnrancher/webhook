...
replace (
	...
	github.com/rancher/rancher/pkg/apis => github.com/cnrancher/pandaria/pkg/apis v0.0.0-20241122020458-2ec2660c3217
...
require (
	...
	github.com/cnrancher/cce-operator v0.3.3 // indirect
